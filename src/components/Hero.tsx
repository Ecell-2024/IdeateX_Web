    ...
    <div className=" flex justify-center items-center mt-[8vh] md:mt-[13vh] w-[100%] ">
      <div className="relative p-4 md:p-12 flex flex-col justify-center w-[92%] h-[90vh] rounded-lg overflow-hidden">
        ...
        <div className="relative z-10">
          <img
            src="/pitch4.png"
            className=" w-[80%] md:w-[50%] mt-0 "
            alt="ok"
            width={500}
            height={600}
          ></img>

          <p className="text-[65px] md:text-[210px] stroke-white stroke-2 mt-0 md:mt-[-85px]  text-transparent bg-clip-text bg-gradient-to-r from-[#AD0C60] to-[#530AAC] font-[900] ">
            IDEATEX
          </p>
